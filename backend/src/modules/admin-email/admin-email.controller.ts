...
export class AdminEmailController {
  ...
  @Post('test') @Throttle({ default: { limit: 3, ttl: 3_600_000 } })
  test(@Body(new ZodValidationPipe(emailTestSchema)) input: EmailTestInput) { return this.email.sendTestEmail(input.recipient); }
}
