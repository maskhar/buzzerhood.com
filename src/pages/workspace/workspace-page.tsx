...
export function WorkspacePage() {
  ...
  if (!access.data?.length) return <main className="workspace-page"><p className="eyebrow">ACCOUNT ACTIVE</p><h1>Workspace belum tersedia.</h1><p>{user?.email ?? 'User'} berhasil masuk, tetapi belum memiliki membership aktif. Onboarding Client dan Partner akan dipindahkan ke Backend pada slice B4 berikutnya.</p></main>;
