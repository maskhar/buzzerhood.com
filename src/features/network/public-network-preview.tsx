...
export function PublicNetworkPreview() {
  ...
  const network = useQuery({ queryKey: ['public-network'], queryFn: getPublicNetworkPartners, enabled: hasSupabaseConfig, staleTime: 60_000 });
