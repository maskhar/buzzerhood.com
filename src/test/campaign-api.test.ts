...
describe('campaign Backend API adapter',()=>{
 ...
 it('maps campaign DTO to the existing frontend contract',async()=>{apiRequest.mockResolvedValue({data:[{id:'campaign-1',organizationId:'org-1',name:'Campaign',referenceCode:'REF-1',status:'draft',objectiveSummary:null,plannedStart:null,plannedEnd:null,estimatedBudget:1000,currency:'IDR',createdAt:'2026-09-06T00:00:00Z',updatedAt:'2026-09-06T00:00:00Z'}]});await expect(getClientCampaigns()).resolves.toEqual([{id:'campaign-1',organization_id:'org-1',organization_name:null,name:'Campaign',reference_code:'REF-1',status:'draft',objective_summary:null,planned_start:null,planned_end:null,estimated_budget:1000,currency:'IDR',created_by:'',created_at:'2026-09-06T00:00:00Z',updated_at:'2026-09-06T00:00:00Z'}]);});
